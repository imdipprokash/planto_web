        ...
        <div className="container mx-auto max-w-4xl prose prose-lg">
          <div className="text-gray-700 space-y-8">
            ...
            <div>
              ...
              <h3 className="text-gray-900 mb-3 mt-6">Analytics Cookies</h3>
              <p>
              ...
              <h3 className="text-gray-900 mb-3 mt-6">Functional Cookies</h3>
              <p>
              ...
              <h3 className="text-gray-900 mb-3 mt-6">Advertising Cookies</h3>
              <p>
            ...
            <div>
              <h2 className="text-gray-900 mb-4">Managing Cookies</h2>
              
              <h3 className="text-gray-900 mb-3">In the App</h3>
              <p>
              ...
              <h3 className="text-gray-900 mb-3 mt-6">On Your Device</h3>
              <p>
            ...
            <div>
              <h2 className="text-gray-900 mb-4">Cookie Duration</h2>
              
              <h3 className="text-gray-900 mb-3">Session Cookies</h3>
              <p>
                These are temporary cookies that expire when you close the App. They help maintain your session state.
              </p>

              <h3 className="text-gray-900 mb-3 mt-6">Persistent Cookies</h3>
              <p>
            ...
            <div>
              <h2 className="text-gray-900 mb-4">Do Not Track</h2>
              <p>
            ...
            <div>
              <h2 className="text-gray-900 mb-4">More Information</h2>
              <p>
                For more information about how we handle your data, please review our:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li><a href="/privacy" className="text-green-600 hover:text-green-700">Privacy Policy</a></li>
                <li><a href="/terms" className="text-green-600 hover:text-green-700">Terms of Service</a></li>
              </ul>
            </div>
